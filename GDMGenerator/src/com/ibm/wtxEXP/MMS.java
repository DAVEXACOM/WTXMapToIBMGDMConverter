 ...
 *       &lt;/sequence>
 *       &lt;attribute name="mapcount" use="required" type="{http://www.w3.org/2001/XMLSchema}string" />
...
public class MMS {
    ...
    @XmlAttribute(name = "mapcount", required = true)
    protected String mapcount;
     ...
     *     
     */
    public void setMapcount(String value) {
        this.mapcount = value;
    }
